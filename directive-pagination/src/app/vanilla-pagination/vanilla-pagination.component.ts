...
@Component({
  selector: 'app-vanilla-pagination',
  templateUrl: './vanilla-pagination.component.html',
  styleUrls: ['./vanilla-pagination.component.scss']
})
export class VanillaPaginationComponent {
  currentPage = 0;
  images = [
    {
      title: 'At the Beach',
